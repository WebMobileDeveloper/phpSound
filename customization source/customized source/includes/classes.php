...
function permalink($url)
{
    ...
    if ($settings['permalinks']) {
        ...
        $path['payment'] = 'index.php?a=payment';
        ...
        } elseif (strpos($url, $path['payment'])) {
            $url = str_replace(array($path['payment'], '&b='), array('payment', '/'), $url);
