...
function reload() {
	...
	$('.edit-menu-item').click(function() {
		...
		$('.edit-general,.edit-registration,.edit-limits,.edit-artistPayments,.edit-emails,.edit-metadata,.edit-permissions,.edit-payments,.edit-reports,.edit-delete,.stats-tracks,.stats-users,.stats-geographic').hide();
		$('.'+$(this).attr('id')).show();
	});
